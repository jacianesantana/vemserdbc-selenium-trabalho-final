...
public class CupomPage extends BasePage{
    ...
    private static final By bntPegarCupon =
            By.cssSelector("#__next > div > div:nth-child(2) > div.css-dvxtzn > div.css-11hxyna > div > " +
                    "div.css-ycvhkc > a:nth-child(1) > div > div.highlight-card__cupom-cta.css-1tslja8");
    ...
    private static final By campoPesquisa =
            By.cssSelector("#__next > div > header > div > div > div > " +
                    "div.search-region.col-xl-7.col-lg-6.col-sm-12 > div > input");

    private static final By bntLoja =
            By.cssSelector("#__next > div > div:nth-child(2) > div.css-dvxtzn > div > " +
                    "div > div.css-1mgz10 > div > a > div");

    private static final By textValidateLoja =
            By.cssSelector("#__next > div > div:nth-child(2) > div > div > div > main > div > div > " +
                    "div.partner-promotions-list > div.promotions-list-header.css-1czkgpg > h1");

    private static final By textValidateErroLoja =
            By.cssSelector("#__next > div > div:nth-child(2) > div.css-dvxtzn > div > " +
                    "div > div.search-no-results > h1");
