#language:pt
  ...
  Funcionalidade: Cashback
    ...
    Contexto: O usuario deve acessar a pagina Cashback e suas paginas de suporte

      @smoke
      Cenario: Validar botao Cashback com sucesso
        Dado que estou na página Home
        Quando acesso Cashback
        Entao devo ser redirecionado para a tela de cashback

      @smoke
      Cenario: Validar botao Entender Regras com sucesso
        Dado que estou na página Home
        Quando acesso Cashback
      ...
      @smoke
      Cenario: Validar botao Ver Duvidas Frequentes de resgate com sucesso
        Dado que estou na página Home
        Quando acesso Cashback
      ...
      @smoke
      Cenario: Validar botao Ver Duvidas Frequentes de saldo e extrato com sucesso
        Dado que estou na página Home
        Quando acesso Cashback
